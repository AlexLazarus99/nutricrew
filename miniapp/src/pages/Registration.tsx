...
export function RegistrationPage({ onComplete, displayName }: Props) {
  ...
  return (
    ...
    <section className="stack registration-page">
      ...
      <div className="card hero">
        ...
        <h2>{t("registration.title", { name: displayName ?? t("registration.friend") })}</h2>

        <p className="muted">{t("registration.subtitle")}</p>
