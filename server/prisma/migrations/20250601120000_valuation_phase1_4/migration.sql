...
CREATE TABLE IF NOT EXISTS "food_search_cache" (
    ...
    CONSTRAINT "food_search_cache_pkey" PRIMARY KEY ("query_key")
);
...
CREATE TABLE IF NOT EXISTS "team_recipes" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "team_recipes_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "team_recipe_votes" (
    "recipe_id" UUID NOT NULL,
    "user_id" BIGINT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "team_recipe_votes_pkey" PRIMARY KEY ("recipe_id","user_id")
);
...
CREATE TABLE IF NOT EXISTS "wearable_imports" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "user_id" BIGINT NOT NULL,
    "source" VARCHAR(32) NOT NULL,
    "payload" JSONB NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "wearable_imports_pkey" PRIMARY KEY ("id")
);
