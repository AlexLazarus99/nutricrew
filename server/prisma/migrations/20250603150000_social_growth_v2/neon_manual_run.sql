-- Neon SQL Editor: run each block separately (select block → Run).
-- Do NOT paste file paths. Wait for "Success" before the next block.
...
CREATE TABLE IF NOT EXISTS "meal_kudos" (
  ...
  "emoji" VARCHAR(8) NOT NULL DEFAULT 'fire',
...
-- Block 3: favorite_meals (FULL statement — do not cut off)
...
-- Block 4: team_challenge_progress
...
-- Block 6: achievements + battle pass
