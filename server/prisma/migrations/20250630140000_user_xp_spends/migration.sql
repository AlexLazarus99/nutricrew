-- Track XP spent on bird unlocks (lifetime XP is computed; spends reduce available balance)
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_xp_spends_user_id_fkey') THEN
